...
#' @param randomizeAllTrials  A boolean that specifies whether all the trials from all the sets are placed in a large vector and are randomized. TRUE = Randomize all the trials, ignoring set boundaries.  FALSE = the randomization follows the two rules above instead: `randomizeSetOrder` ("fixed", "randomFirst" or "randomAll") for the order of the sets, and `randomizeTrialInSetOrder` (TRUE or FALSE) for the order of the trials within each set. DEFAULT = FALSE
#'
