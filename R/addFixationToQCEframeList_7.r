...
addFixationToQCEframeList_7 <- function (QCEframeList = NULL, frameSymbol = '+', fixationFontSize = "50px", fixationColor = "#FF6464", stimulus_duration = 500,  post_trial_gap = 500, stimTableWidth = 100, background = "#000000", output = FALSE) {
